let aboutcontents = 
    "<div class=\"textdoc\">\
        ...
        \
        <p>I am currently working as a Linux platform software engineer in the data storage<br/>\
        sector, but this is just a small part of what I like to do. I also have a passion<br/>\
        ...
        \
        <p>I have more recently begun to fall in love with Rust. It provides a very sane middle<br/>\
        ground between many other programming languages in that it allows for very high-level<br/>\
        abstractions without sacrificing data control or performane. Additionally, its memory safety<br/>\
        model is very robust and prevents a lot of the sloppy errors that languages like C or C++ can<br/>\
        cause.</p>\
        \
